            ...
            const gameData = {
                ...
                setScores: validationResult.data.setScores 
                    ? (typeof validationResult.data.setScores === 'string' 
                        ? JSON.parse(validationResult.data.setScores) 
                        : validationResult.data.setScores)
                    : {},
                setsWon: validationResult.data.setsWon 
                    ? (typeof validationResult.data.setsWon === 'string' 
                        ? JSON.parse(validationResult.data.setsWon) 
                        : validationResult.data.setsWon)
                    : {"home":0,"away":0},
                ...
                // Add userId field to associate game with authenticated user
                userId: userId
